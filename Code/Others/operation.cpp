 ...
 */
void printMiddleResult(ofstream &out_cp, timeval t1, double preTime, int Qcount, double csize, long mem_baseline)
{
    ...
    std::cout << Qcount << "    " << csize << "    " << time_cost - preTime << "    " << get_mem_usage() - mem_baseline << "\n";
    out_cp << Qcount << "    " << csize << "    " << time_cost - preTime << "    " << get_mem_usage() - mem_baseline << "\n";
}
